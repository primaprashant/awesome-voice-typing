...
3. Use these column rules:
   ...
   | Platforms | All supported platforms, comma-separated | `Linux, macOS, Windows` |
...
If a project's details have changed, update the relevant row in the directory. Include a link to the relevant release, commit, or documentation change in your PR description when possible.
