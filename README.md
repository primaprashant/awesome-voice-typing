...
| [Voz](https://github.com/quietbin/voz-mac)<br/><br/>![stars](https://img.shields.io/github/stars/quietbin/voz-mac?style=plastic&label=%E2%98%85) | macOS | Local | Whisper.cpp | Hotkey dictation that types at the cursor in any app; Whisper model ships inside the bundle so there is no setup or download. Also records meetings and transcribes files locally. |
