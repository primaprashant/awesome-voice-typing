...
| [voice2ai](https://github.com/lfzds4399-cpu/voice2ai)<br/><br/>![stars](https://img.shields.io/github/stars/lfzds4399-cpu/voice2ai?style=plastic&label=%E2%98%85) | Windows | Cloud | Groq, OpenAI Whisper, SiliconFlow, Azure Speech | Push-to-talk or VAD-continuous dictation; transcript auto-pastes into the focused chat app (VS Code / Cursor / WeChat / browsers, 10+ apps). |
